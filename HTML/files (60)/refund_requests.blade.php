...
@section('content')
    <div class="panel">
        <div class="panel-heading bord-btm clearfix pad-all h-100">
            <h3 class="panel-title pull-left pad-no">{{__('Refunds')}}</h3>
                    ...
                    <table class="table table-striped res-table mar-no" >
                        ...
                        @foreach ($orders as $key => $order_id)
                            @php
                              ...
                              if(($status =='Unauthorised Request' || $status == 'Authorised Request' || $status == 'Cancelled Request' || $status == 'Refund Pending') && $i==4)continue;
