...
@if(permission_check_all('sub_sub_categories') || permission_check_post('sub_sub_categories'))
<div class="row">
    <div class="col-sm-12">
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    @if(permission_check_all('sub_sub_categories') || permission_check_put('sub_sub_categories'))
                                        <li><a href="{{route('subsubcategories.edit', encrypt($subsubcategory->id))}}">{{__('Edit')}}</a></li>
                                    @endif
                                    @if(permission_check_all('sub_sub_categories') || permission_check_delete('sub_sub_categories'))
