...
@php
    ...
    $color = App\GeneralSetting::first()->color;
@endphp
...
.bg-base-1.ss-style-zigzag::after {
    background-image: -webkit-gradient(linear, 0 0, 300% 100%, color-stop(0.25,{{$color}}), color-stop(0.25,{{$color}}));
...
{
    background-color: lighten(<?php echo $color; ?>, 50%);
}

.cta-wrapper > a:hover > .bg-base-1 {
    background: lighten(<?php echo $color; ?>, 50%) !important;
}
...
{
    border-color: lighten(<?php echo $color; ?>, 50%);
}
...
@media (min-width: 768px) {
    .promos.bg-base-1 .scale {
        box-shadow: 0 0 4px 1px lighten(<?php echo $color; ?>, 50%);
    }
}
