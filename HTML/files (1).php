...
@if(permission_check_all('SMTP') || permission_check_post('SMTP'))
    <div class="row">
        <div class="col-sm-12">
...
@if(Auth::user()->user_type == 'admin' ||in_array('products', json_decode(Auth::user()->staff->role->permissions_all)) ||in_array('products', json_decode(Auth::user()->staff->role->permissions_get)) ||in_array('products', json_decode(Auth::user()->staff->role->permissions_put)) || in_array('products', json_decode(Auth::user()->staff->role->permissions_post)) ||in_array('products', json_decode(Auth::user()->staff->role->permissions_delete)))
<div class="row">
    <div class="col-md-6">
        <div class="panel">
...
@if((Auth::user()->user_type == 'admin' || in_array('sellers', json_decode(Auth::user()->staff->role->permissions_all))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
<div class="row">
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
...
@if(Auth::user()->user_type == 'admin' || in_array('categories', json_decode(Auth::user()->staff->role->permissions_all)))
    <div class="row">
    <div class="col-md-6">
        <div class="panel">
            <!--Panel heading-->
...
@if(Auth::user()->user_type == 'admin' || in_array('banners', json_decode(Auth::user()->staff->role->permissions_all)))
    <div class="row">
    <div class="col-md-6">
        <div class="panel">
...
@if(Auth::user()->user_type == 'admin' || in_array('business_settings', json_decode(Auth::user()->staff->role->permissions_all)))
    <div class="flex-row">
