        ...
        <div class="text-center">
            ...
            <form class="pad-hor" method="POST" role="form" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input id="text" type="email" class="form-control {{ $errors->has('username') || $errors->has('email') ? ' is-invalid' : '' }}" name="identity" value="{{ old('username') ?: old('email') }}" required autofocus placeholder="Email or Username">
                    @if ($errors->has('email'))
