                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @if(permission_check_all('in_house_orders') || permission_check_get('in_house_orders') )
                                            <li><a href="{{ route('orders.show', encrypt($order->id)) }}">{{__('View')}}</a></li>
                                        @endif
                                        @if(permission_check_all('in_house_orders') || permission_check_put('in_house_orders') )
                                        <li><a href="{{ route('seller.invoice.download', $order->id) }}">{{__('Download Invoice')}}</a></li>
                                        @endif
                                        @if(permission_check_all('in_house_orders') || permission_check_delete('in_house_orders') )
