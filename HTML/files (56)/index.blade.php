...
@if(permission_check_all('roles') || permission_check_post('roles') )
<div class="row">
    <div class="col-sm-12">
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    @if(permission_check_all('roles') || permission_check_put('roles') )
                                        <li><a href="{{route('roles.edit', encrypt($role->id))}}">{{__('Edit')}}</a></li>
                                    @endif
                                    @if(permission_check_all('roles') || permission_check_delete('roles') )
