            ...
            <form class="form-horizontal" action="{{ route('business_settings.vendor_commission.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="type_pay" value="{{ $business_settings_pay->type }}">
                        <label class="col-lg-3 control-label">{{__('Payment Commission')}}</label>
                        <div class="col-lg-7">
                            <input type="number" min="0" step="0.01" value="{{ $business_settings_pay->value }}" placeholder="{{__('Payment Commission')}}" name="value_pay" class="form-control">
                        </div>
                        <div class="col-lg-1">
                            <option class="form-control">%</option>
                        </div>
