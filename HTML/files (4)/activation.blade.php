...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Dispute Activation')}}</h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
                    <input type="checkbox" onchange="updateSettings(this, 'dispute_system')" <?php if(\App\BusinessSetting::where('type', 'dispute_system')->first()->value == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Product Query')}}</h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
                    <input type="checkbox" onchange="updateSettings(this, 'product_query')"  <?php if(\App\BusinessSetting::where('type', 'product_query')->first()->value == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function updateSettings(el, type){
            ...
            if($(el).is(':checked')){
                ...
                @if(!App\MaintenanceWhitelist::first() ||App\MaintenanceWhitelist::first()->whitelist == '')
                if(type == 'maintenance_mode'){
                    showAlert('danger', 'Please first add the whitelist');
                    el.checked = false;
                    return 0;
                }
                @endif
