...
@section('content')
    ...
    <div class="row">
    @if(permission_check_all('languages') || permission_check_put('languages')  )
        <div class="col-lg-6">
            <div class="panel">
    ...
    @if(permission_check_all('languages') || permission_check_post('languages')  )
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        @foreach ($languages as $key => $language)
                            <tr>
                                ...
                                <td>
                                 @if(permission_check_all('languages') || permission_check_put('languages') || permission_check_post('languages'))
                                <label class="switch">
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                            		 ...
                            		 @if(permission_check_all('languages') || permission_check_put('languages') )
                             		 ...
                             		 @if(permission_check_all('languages') || permission_check_delete('languages') )
                                            @if($language->code != 'en')
