...
<head>
    ...
    <!--shop Stylesheet [ REQUIRED ]-->
    <link href="{{ asset('css/shop.min.css')}}" rel="stylesheet">

    <!--shop Premium Icon [ DEMONSTRATION ]-->
    <link href="{{ asset('css/demo/shop-demo-icons.min.css')}}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{asset('css/hide_under_plus.css')}}">
    <!--Chosen [ OPTIONAL ]-->
    ...
    <!--shop [ RECOMMENDED ]-->
    <script src="{{ asset('js/shop.min.js') }}"></script>
    ...
    <!--Custom JavaScript [ REQUIRED ]-->
    <script src="{{ asset('js/hide_under_plus.js')}}"></script>
