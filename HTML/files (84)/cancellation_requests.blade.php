...
@section('content')
    ...
    <div class="panel-body">
        <div class="tab-base tab-stacked-left">
                ...
                <li class="">
                    <a data-toggle="tab" href="#demo-stk-lft-tab-4" aria-expanded="false">{{__('Unauthorised')}}</a>
                </li>
                <li class="">
                    <a data-toggle="tab" href="#demo-stk-lft-tab-5" aria-expanded="false">{{__('Cancelled')}}</a>
                </li>
                <li class="">
                    ...
                    <table class="table table-striped res-table mar-no" >
                        ...
                        @foreach ($orders as $key => $order_id)
                            @php
                                ...
                                if($status_array[$key] != 'Cancellation Pending' && $i==1)continue;
                                else if($status_array[$key] != 'Cancelled Request' && $i==2)continue;
                                else if($status_array[$key] != 'Cancelled Return' && $i==3)continue;
                                else if($status_array[$key] != 'cancelled' && $i==4){continue;};
                            ...
                            @if($order != null)
                                <tr>
                                    ...
                                    <td>    {{ $order->orderDetails->first()->seller->user->name ?? 'admin' }} </td>
                                    <td>
