                        ...
                        <div class="col-lg-9">
                            <select name="coupon_type" id="coupon_type" class="form-control demo-select2-placeholder" onchange="coupon_form()" required>
                                ...
                                @elseif ($coupon->type == "cart_base")
                                    <option value="cart_base" selected>{{__('For Total Orders')}}</option>
                                @elseif ($coupon->type == "seller_base")
                                    <option value="seller_base" selected>{{__('For Seller Orders')}}</option>
                                @elseif ($coupon['type']  == 'sitewide' || $coupon['type'] == 'product')
                                    <option value="gifts_base" selected>{{__('For Gift Orders')}}</option>
                                @endif
                            </select>
                        </div>
                    </div>
