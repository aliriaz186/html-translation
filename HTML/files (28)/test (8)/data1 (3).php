            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                ...
                <div class="caorusel-box arrow-round gutters-5">
                    ...
                    <div class="slick-carousel" data-slick-items="3" data-slick-lg-items="2"  data-slick-md-items="2" data-slick-sm-items="1" data-slick-xs-items="1" data-slick-rows="2">
                        @foreach (filter_products(\App\Product::where('published', 1)->where("shown","!=","hidden")->orderBy('num_of_sale', 'desc'))->limit(20)->get() as $key => $product)
                            ...
                            <div class="caorusel-card my-1">
                                <div class="row no-gutters product-box-2 align-items-center">
			                     ...
			                     <div>
			                       <span style="left:67%" class="product-label label-hot">{{__('Free Returns')}}</span>
			                    </div>
			                   @endif
