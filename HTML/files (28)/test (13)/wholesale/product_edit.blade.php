                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('wholesale.products.edit.seller', $product->id) }}">{{__('Edit Wholesale Product')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="" action="{{route('wholesale.products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product W.Category')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row" id="quantity">
                                        <div class="col-md-2">
                                            <label>{{__('Min Quantity')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="1" class="form-control mb-3" name="min_stock" placeholder="{{__('Min Quantity')}}" value="{{$product->min_stock}}">
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Max Quantity')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="1" class="form-control mb-3" name="max_stock" placeholder="{{__('Max Quantity')}}" value="{{$product->max_stock}}">
                                        </div>
                                    </div>
                                    <div class="row">
