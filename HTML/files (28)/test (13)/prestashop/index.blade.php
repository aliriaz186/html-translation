...
<section class="gry-bg py-4 profile">
                            ...
                            <div class="col-md-6">
                                <div class="float-md-right">
                                    <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('import_data.shopify') }}">{{__('Prestashop Import')}}</a>
                                            </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div style="width:100%">
                                 <div class="card no-border mt-4" style="width:100%">
                                    <div class="card-header py-3">
                                        <h4 class="mb-0 h6">Prestashop</h4>
                                      <a href="{{route('prestashop.changePage')}}" class="pull-right btn btn-info" style="margin-top: -3%" >Change</a>
                                      <a href="{{route('prestashop.delete')}}" class="pull-right btn btn-danger mr-2" style="margin-top: -3%" >Delete</a>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($products as $key => $product)
                                                        <tr>
                                                        <td>{{$i+1}}</td>
                                                        <td><img loading="lazy"  class="img-md" src="{{config('prestashop-webservice.url')}}/api/images/products/{{$product->id}}/{{$product->id_default_image}}?ws_key={{config('prestashop-webservice.token')}}"></td>
                                                        <td>{{$product->name->language}}</td>
                                                        <td>{{$product->description_short->language}}</td>
                                                        <td>
            ...
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row no-gutters modal-categories mt-4 mb-2">
                                    ...
                                    <div class="modal-category-list has-right-arrow">
                                        <ul class="categories">
                                            @foreach ($categories as $key => $category)
                                                <li onclick="get_subcategories_by_category(this, {{ $category->id }},{{$product->id}})">{{ __($category->name) }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="modal-category-box c-scrollbar" class="subcategory_list">
                                    <div class="sort-by-box">
                                        <form role="form" class="search-widget">
                            ...
                            <div class="col-4">
                                <div class="modal-category-box c-scrollbar" class="subsubcategory_list">
                                    <div class="sort-by-box">
                                        <form role="form" class="search-widget">
    ...
    @if(count($products)>0)
    <form action="{{route('prestashop-import-product')}}" method="POST" id="form_wordpress">
        @csrf
...
@section('script')
    <script>
        ...
        function get_subcategories_by_category(el, cat_id,product_id){
