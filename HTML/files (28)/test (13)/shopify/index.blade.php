...
<section class="gry-bg py-4 profile">
                            ...
                            <div style="width:100%">
                                 <div class="card no-border mt-4" style="width:100%">
                                    <div class="card-header py-3">
                                        <h4 class="mb-0 h6">Shopify</h4>
                                          @php $RSPY = App\RegisterShopify::where('seller_id',Auth::user()->id)->first();  @endphp
                                      @if(!$RSPY)
                                         <a href="{{route('shopify.registerPage')}}" class="pull-right btn btn-success" style="margin-top: -3%" >Register</a>
                                      @else
                                      <a href="{{route('shopify.changePage')}}" class="pull-right btn btn-info" style="margin-top: -3%" >Change</a>
                                      <a href="{{route('shopify.delete')}}" class="pull-right btn btn-danger mr-2" style="margin-top: -3%" >Delete</a>
                                      @endif
                                    </div>
                                    <div class="card-body">
                                                            ...
                                                            <td>
                                                                <a target="_blank" class="media-block">
                                                                    <div class="media-left">
                                                                        <img loading="lazy"  class="img-md" src="{{ $product->image->src}}" alt="Image">
                                                                    </div>
    ...
    @endforeach
    @if(count($products)>0)
    <form action="{{route('shopify-import-product')}}" method="POST" id="form_shopify">
        @csrf
