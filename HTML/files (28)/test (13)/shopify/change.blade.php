                        ...
                        <div class="row">{{-- card no-border mt-4 --}}
                            <div style="width:100%">
                                <div class="card no-border mt-4" style="width:100%">
                                    ...
                                    <div class="card-body">
                                        @php $RSPY = App\RegisterShopify::where('seller_id',Auth::user()->id)->first();  @endphp

                                        <form action="{{route('shopify.change')}}" method="POST">
                                        @csrf
                                            <div class="form-group">
                                                <label for="SHOPIFY_API_KEY">SHOPIFY_API_KEY</label>
                                                <input type="text" id="SHOPIFY_API_KEY" value="{{$RSPY->shipify_api_key}}" required class="form-control" name="SHOPIFY_API_KEY" placeholder="Api key">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="SHOPIFY_ACCESS_TOKEN" value="{{$RSPY->shipify_access_token}}" required class="form-control" name="SHOPIFY_ACCESS_TOKEN" placeholder="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">
                                            </div>
                                            <div class="form-group">
                                                <label for="SHOPIFY_API_KEY">SHOPIFY_SHOP_DOMAIN</label>
                                                <input type="text" id="SHOPIFY_SHOP_DOMAIN" value="{{$RSPY->shipify_shop_domain}}" required class="form-control" name="SHOPIFY_SHOP_DOMAIN" placeholder="shopfytolaravel.myshopify.com">
                                            </div>
                                            <div class="form-group">
