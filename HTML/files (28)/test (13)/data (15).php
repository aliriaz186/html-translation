...
@section('content')
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                                ...
                                <div class="form-box-title px-3 py-2">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch mt-1">
                                            <input type="checkbox" name="wholesale_active" onchange="wholesale_change(this)">
                            ...
                            <div id="customer_choice_wholesale">
                                <div class="form-box bg-white mt-4">
                                    <div class="form-box-title px-3 py-2">
                                        {{__('Customer Choice Wholesale')}}
                                    </div>
                                    <div class="form-box-content p-3">
                                        <div class="row mb-3">
                                            <div class="col-8 col-md-3 order-1 order-md-0">
                                                <input type="text" class="form-control" value="{{__('Colors Wholesale')}}" disabled>
                                            </div>
                                            <div class="col-12 col-md-7 col-xl-8 order-3 order-md-0 mt-2 mt-md-0">
                                                <select class="form-control color-var-select" name="colors[]" id="colors" multiple disabled>
                                                    @foreach (\App\Color::orderBy('name', 'asc')->get() as $key => $color)
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-3">
                                                <label>{{__('Attributes Wholesale')}}</label>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="">
                                                    <select name="choice_attributes[]" id="choice_attributes" class="form-control selectpicker" multiple data-placeholder="Choose Attributes">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="min_discount_data">
                                                <div class="row">
                                                    <div class="col-md-2 d-flex align-items-center text-center">
                                                        <label>{{__('Min')}}</label>
                                                    </div>
                                                    <div class="col-md-2 d-flex align-items-center text-center">
                                                        <input type="number" min="1" value="1" class="form-control mb-3" name="min[]" placeholder="{{__('Min')}}" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 d-flex align-items-center text-center">
                                                        <input type="number" min="1" class="form-control mb-3" name="max[]" placeholder="{{__('Max')}}" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 d-flex align-items-center text-center">
                                                        <input type="number" min="0" value="" max=100 class="form-control mb-3" name="discount[]" placeholder="{{__('%')}}" required>
                                                    </div>
                                                    <div class="col-md-1 d-flex align-items-center text-center align-self-start column-gap">
                                                        <button class="btn" data-toggle="tooltip" title="Add new range" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="add_min_max_row()">
                                            ...
                                            <div class="modal-content" style="    width: 164%;margin-left: -22%;">
                                                ...
                                                <div class="modal-body">
                                                    <div  id="upload_button">
                                                        <div class="image-upload d-block text-center">
                                                            <label for="actual_input">
                                                             <img src="{{asset('uploads/shop/upload-to-cloud.png')}}"/>
                                                              <p>{{__('Upload Images and then Drag & Drop')}}</p>
                                                            </label>
                                                          </div>
                                                ...
                                                <button type="button"  onclick="upload_save(this)" class="btn btn-primary">Save</button>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
    ...
    <div class="modal fade" id="categorySelectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
        ...
        @foreach ($categories as $key => $category)
            <div class="modal fade" id="ticket_modal_{{$key}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content position-relative">
                        ...
                        <div class="modal-body px-3 pt-3">
                            <form class="" action="{{ route('support_ticket.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <input type="text" class="form-control mb-3" disabled name="subject" value="Request for {{$category->name}}" placeholder="Subject" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="file" name="attachments[]" id="file-{{$key}}" class="custom-input-file custom-input-file--2" data-multiple-caption="{count} files selected" multiple />
                                        <label for="file--{{$key}}" class=" mw-100 mb-0">
                                        <i class="fa fa-upload"></i>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#customer_choice_wholesale').hide();

            $('.demo-select2').select2();
        });

        function ondelete_row(em){
    ...
    increment=2;
        ...
        function premiumChange(country,event){
         console.log($(`.${country}_dafault_company_label`).fadeIn());
...
function afterImagesUpload(event){
    ...
    function wholesale_change(el){
        if(el.checked){
            $('#customer_choice_normal').fadeOut();
            $('#customer_choice_wholesale').fadeIn();
        }else{
            $('#customer_choice_normal').fadeIn();
            $('#customer_choice_wholesale').fadeOut();
        }
    }

    function add_min_max_row(){
        var min_discount_data = `
                <div class="row">
                    <div class="col-md-2 d-flex align-items-center text-center">
                        <label>{{__('Min')}}</label>
                    </div>
                    <div class="col-md-2 d-flex align-items-center text-center">
                        <input type="number" min="0" value="0" class="form-control mb-3" name="min[]" placeholder="{{__('Min')}}" required>
                    </div>
                    ...
                    <div class="col-md-2 d-flex align-items-center text-center">
                        <input type="number" min="0" value="0" class="form-control mb-3" name="max[]" placeholder="{{__('Max')}}" required>
                    </div>
                    ...
                    <div class="col-md-2 d-flex align-items-center text-center">
                        <input type="number" min="0"  step="0.01" class="form-control mb-3" name="discount[]" placeholder="{{__('%')}}" required>
                    </div>
                    <div class="col-md-1 d-flex align-items-center text-center align-self-start column-gap">
                        <button class="btn" data-toggle="tooltip" title="Add new range" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="add_min_max_row()">
                            <i class="fa fa-plus"></i>
                        </button>
                        <button class="btn ml-1" data-toggle="tooltip" title="Add new range" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="ondelete_row(this)">
        ...
        `;
            $(`#min_discount_data`).append(min_discount_data);
