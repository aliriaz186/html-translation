                    ...
                    <div class="main-content">
                        ...
                        <div class="page-title">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('purchases.cancellation_request') }}">{{__('Cancellation Request')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                          ...
                          <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="Unauthorised-tab" data-toggle="tab" href="#unauthorised" role="tab" aria-controls="unauthorised" aria-selected="false">Cancelled request</a> </li>         
                        ...
                        <div class="tab-content" id="myTabContent">
                             ...
                             <div class="tab-pane fade ($i==0)?'show active':''" id="{{$id}}" role="tabpanel" aria-labelledby="{{$id}}-tab">
                                                                    ...
                                                                    <div class="col-md-12 details_part_product_img slingle_item_address_part">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4 col-sm-4 col-xs-12 no-print">
                                                                                ...
                                                                                <strong class="font-weight-bold">{{ ucfirst(str_replace('-',' ',$order->cancellation_request)) }}</strong><br>
