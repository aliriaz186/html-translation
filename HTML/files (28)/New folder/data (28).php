                    ...
                    <!-- <div class="bg-white"> -->
                        ...
                        <div class="products-box-bar p-3 bg-white">
                            <div class="row sm-no-gutters gutters-5">
                                @if(count($products_promo)>0)
                                @foreach ($products_promo as $key => $product)
                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-6">
                                    <div class="product-box-2 bg-white alt-box my-md-2">
                                        ...
                                        <div class="p-md-3 p-2">
                                            <span class="badge badge-danger pull-right mb-2 mt-2 mr-2">Promoted</span>
                                            <div class="price-box">
                            ...
                            @endforeach
                                ...
                                @foreach ($products as $key => $product)
                                    @php $noFound = true;  @endphp
                                    @foreach ($products_promo as $product_promo)
                                            @if($product->id == $product_promo->id)
                                                @php $noFound = false; @endphp
                                                @continue
                                            @endif
                                    @endforeach
                                    @if($noFound)
