                                            ...
                                            <tbody>
                                                @foreach ($order->orderDetails as $key => $orderDetail)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{ single_price($price) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="col-xl-5 col-md-6 ml-auto">
                                            <table class="table details-table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>{{__('Loyalty Discount')}}</th>
                                                        <td class="text-right">
                                                            <span class="text-italic">{{ single_price($order->loyality_discount) }}</span>
                                                        </td>
                                                    </tr>
                                                       <tr>
                                                        <th>{{__('Cashback Discount')}}</th>
                                                        <td class="text-right">
                                                            <span class="text-italic">{{ single_price($order->cashback_discount) }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <strong><span>{{ single_price($order->wholesale_discount) }}</span></strong>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
