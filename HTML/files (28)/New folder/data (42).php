                    ...
                    <div class="form-default bg-white p-4">
                                ...
                                <table class="table-cart border-bottom">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach (Session::get('cart') as $key => $cartItem)
                                            ...
                                            $discount = getWholesale($cartItem);
                                            @endphp
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-total">
                                                    <span>{{ single_price(($cartItem['price']+$cartItem['tax'])*$cartItem['quantity'] - $discount ) }}</span>
                                                </td>
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <button class="btn btn-styled btn-base-1" onclick="showApiNotification()">{{__('Continue to Shipping')}}</button>
                                @elseif (Auth::check())
