                    ...
                    <div class="main-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center plus-widget mt-4 c-pointer" onclick="show_wallet_modal()">
                                    ...
                                    <span class="d-block title heading-6 strong-400 c-base-1">{{ __('Top up Wallet') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card no-border mt-5">
                            <div class="card-header py-3">
                                <h4 class="mb-0 h6">{{__('Wallet Top up History')}}</h4>
                            </div>
                            <div class="card-body">
                                            ...
                                            @foreach ($wallets as $key => $wallet)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($wallet->message && $wallet->amount <=0)
                                                        {{ single_price($wallet->amount) }}
                                                        @elseif($wallet->message && $wallet->amount >=0)
                                                    ...
                                                    <td>
                                                        @if(!$wallet->message)
                                                        {{ ucfirst(str_replace('_', ' ', $wallet ->payment_method)) }}</td>
                                                        @elseif($wallet->message && $wallet->amount >=0)
                                                            Credit
                                                        @elseif($wallet->message && $wallet->amount <=0)
                                                            Debit
