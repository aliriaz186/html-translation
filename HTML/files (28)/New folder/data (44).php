			...
			@if(count($wishlists)==0)
				<div class="card no-border mt-5">
                            <div class="card-header py-3">
                                <h4 class="mb-0 h6">{{__('Wishlist')}}</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="card card-product mb-3 product-card-2">
                                            <div class="card-body p-3">
                                                <div class="card-image">
                                                    <a href="{{ route('product', $wishlist->product->slug) }}" class="d-block" style="background-image:url('{{ asset($wishlist->product->thumbnail_img) }}');background-size: cover;height: 27vh;" >
                                                    </a>
                                                </div>
