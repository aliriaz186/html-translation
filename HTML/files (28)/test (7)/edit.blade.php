...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Classified Product</title>
      <meta name="keywords" content="">
      <meta name="description" content="">
      <meta name="author" content="">

    <!-- style css -->
      <link rel="stylesheet" type="text/css" href="{{asset('frontend/classified_products/css/style.css')}}">
      <!-- Responsive-->
      <link rel="stylesheet" href="{{asset('frontend/classified_products/css/responsive.css')}}">
      <!-- fevicon -->
      <link rel="icon" href="{{asset('frontend/images/logo/logo.png')}}" type="image/gif" />

      <link rel="stylesheet" href="{{asset('frontend/classified_products/css/product_style.css')}}" media="screen">
...
<div class="body-wrap shop-default shop-cards shop-tech gry-bg">
    ...
    @include('frontend.inc.nav_classified')

   </head>
   <body>
      <!--header section start -->

         @yield('classified-content')
...
<script src="{{asset('frontend/classified_products/js/custom.js')}}"></script>
...
<script>
    ...
    function search(){
        ...
        if(search.length > 0){
            ...
            $.get('{{ route('search.ajax_classifed') }}', { _token: '{{ @csrf_token() }}', search:search}, function(data){
                if(data == '0'){
...
@yield('script')
<script src="{{ asset('frontend/js/accountHealthChart.js')}}"></script>
