                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-3 col-8">
                        <div class="d-flex">
                            ...
                            <!-- Brand/Logo -->
                            <a class="navbar-brand w-100" href="{{ route('customer_packages_list_show_frontend') }}">
                                @php
                    ...
                    <div class="col-lg-9 col-4 position-static">
                        <div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search_classified') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="form-group category-select d-none d-xl-block">
                                            <select class="form-control selectpicker" name="category">
                                                ...
                                                @foreach (\App\ClassifiedCategory::all() as $key => $category)
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-none d-lg-inline-block" data-hover="dropdown" id="image_account">
                                    <div class="nav-cart-box dropdown">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            @if (auth()->check())
                                            @if (Auth::user()->avatar_original != null)
                                                <div class="image rounded-circle nav_image"  style="background-image:url('{{ asset(Auth::user()->avatar_original) }}');"></div>
                                            @else
                                            <img src="{{ asset('frontend/images/user.png') }}" class="image rounded-circle nav_image" >
                                            @endif
                                        ...
                                        <div class="small_tab"></div>
                                        <ul class="dropdown-menu dropdown-menu-right px-0 mt-2" id="account_dropdown" style="border:none">
                                            <li class="first_list">
                                                @if (auth()->check())
                                            ...
                                            <li>
                                                <div class="dropdown-account px-0">
                                                            <div class="dc-header">
                                                                <ul  class="list-group">
                                                                 ...
                                                                 <a href="{{ route('dashboard') }}" class="text-dark">
                                                                    ...
                                                                    <a href="{{ route('affiliate.apply') }}" class="text-dark">
                                                                        <li class="list-group-item p-2 list_account" >
                                                                                <i class="la la-road"></i>
                                                                                    {{__('Be an affiliate partner')}}
                                                                        </li>
                                                                    </a>
                                                                    @endif

                                                                    <a href="{{ route('orders.track') }}" class="text-dark">
                                                                        <li class="list-group-item p-2 list_account" >
                                                                                <i class="la la-road"></i>
                                                                                    {{__('Track Order')}}
                                                                        </li>
                                                                    ...
                                                                    <li class="list-group-item p-2 list_account dropdown-submenu">
                                                                        <i class="la la-language"></i>
                                                                        <a href="{{ route('dashboard') }}" class="dropdown-toggle text-dark" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                                                {{__('Languages')}}
                                                                        ...
                                                                        @endphp
                                                                            ...
                                                                            <li class=" @if($locale == $language) active @endif">
                                                                        ...
                                                                        <a href="{{ route('dashboard') }}" class="dropdown-toggle text-dark" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                                            ...
                                                                            @endphp
                                                                                @foreach (\App\Currency::where('status', 1)->get() as $key => $currency)
                                                                                    <li class=" @if($currency_code == $currency->code) active @endif">
                                                                    ...
                                                                    <a href="{{ route('customer_packages_list_show_frontend') }}"  class="text-dark">
                                                                        <li class="list-group-item p-2 list_account" >
                                                                                <i class="la la-tv"></i>
                                                                                    {{__('Visit Classified Ads')}}
                                                                        </li>
                                                                    </a>


                                                                    @elseif(Session::get('user_email'))

                                                                    <li class="list-group-item p-2 list_account" >
                                                                        <a  href="{{ route('api.user-dashboard') }}" class="text-dark">
                                                                            <i class="la la-dashboard"></i>
                                                                                {{__('Dashboard')}}
                                                                        </a>
                                                                    </li>
                                                                    ...
                                                                    <a href="{{ route('customer_packages_list_show') }}"  class="text-dark">
                                                                        <li class="list-group-item p-2 list_account" >
                                                                                <i class="la la-envelope"></i>

                                                                                    {{__('Classified Packages')}}
                                                                        </li>
                                                                    </a>
                                                                    @endif
                                                                    <a href="{{ route('customer_packages_list_show_frontend') }}"  class="text-dark">
                                                                    ...
                                                                    <a  href="{{ route('user.registration') }}" class="text-dark">
                                                                        <li class="list-group-item p-2 list_account" >
                                                                                <i class="la la-file-text"></i>
                                                                                    {{__('Registration')}}
                                                                        </li>
                                                                    ...
                                                                    <a  href="{{ route('user.sell-with-us') }}" class="text-dark">
                                                                        <li class="list-group-item p-2 list_account" >
                                                                                <i class="la la-user"></i>
                                                                                    {{__('Sell With Us')}}
                                                                        </li>
                    ...
                    <div class="col-lg-3 position-static">
                        <div class="category-sidebar" id="category-sidebar">
                            <div class="all-category">
                                <span>{{__('CLASSIFIED CATEGORIES')}}</span>
                                <a href="{{ route('categories.all') }}" class="d-inline-block">See All ></a>
                            </div>
                            <ul class="categories">
                                @foreach (\App\ClassifiedCategory::all()->take(11) as $key => $category)
                                    @php
                                        $brands = array();
                                    @endphp
