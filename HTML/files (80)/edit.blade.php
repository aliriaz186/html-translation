...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{__('Classified Sub Subcategory Information')}}</h3>
        </div>

        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('classified_subsubcategories.update', $subsubcategory->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="classified_sub_category_id" id="sub_category_id" class="form-control demo-select2" required>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#category_id > option").each(function() {
            if(this.value == '{{$subsubcategory->ClassifiedSubcategory->category_id}}'){
